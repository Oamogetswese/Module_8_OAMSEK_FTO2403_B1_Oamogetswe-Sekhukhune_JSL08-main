...
const branchA = new BankBranch({ name: 'Branch A', location: 'Location A' });
const branchB = new BankBranch({ name: 'Branch B', location: 'Location B' });
...
console.log(branchA.getBranchInfo()); // Output: { name: 'Branch A', location: 'Location A' }
console.log(branchB.getBranchInfo()); // Output: { name: 'Branch A', location: 'Location A' }
